...
For example, one may run pyDKE with standard processing using the command:
...
from your DWIs. It's very simple, pyDKE figures this out for you. It analyzes
